    ...
    <Fragment>
      ...
      <div className="relative min-h-screen w-full">
        <button
          ...
          className={`fixed border-none top-[10px] left-[10px] z-10 flex items-center justify-center h-10 w-10 rounded-lg bg-[#303030] ${loading || processingPayment ? "opacity-50 cursor-not-allowed" : ""
            }`}
        >
